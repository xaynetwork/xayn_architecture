...
class _$SettingsTearOff {
  ...
  _Settings call({required bool isReady}) {
    return _Settings(
      isReady: isReady,
    );
  }
...
class _$_Settings extends _Settings {
  const _$_Settings({required this.isReady}) : super._();
  ...
  @override
  String toString() {
    return 'Settings(isReady: $isReady)';
  }
...
abstract class _Settings extends Settings {
  const factory _Settings({required bool isReady}) = _$_Settings;
